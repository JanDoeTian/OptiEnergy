...
export const _sites: ISiteItem[] = [...Array(10)].map((_, index) => ({
  ...
  longitude: [-0.1276, -1.2577, -2.2426, -3.1883, -4.2425, -0.1276, -1.2577, -2.2426, -3.1883, -4.2425][index],
  latitude: [51.5074, 51.7520, 53.4808, 55.9533, 53.8008, 51.5074, 51.7520, 53.4808, 55.9533, 53.8008][index],
  messages: [
    {
      id: _mock.id(index),
      type: 'info',
